...
for k, v in pairs(WeaponSkins.skins) do
  if string.starts_with(k, "es_2h_hammer") or string.starts_with(k, "dw_1h_hammer") or string.starts_with(k, "dw_2h_hammer") or string.starts_with(k, "we_2h_axe") or string.starts_with(k, "dw_2h_pick") then
