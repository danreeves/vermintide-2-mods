...
function mod:toggle_with_hotkey()
  ...
  DebugScreen.is_blocked = not DebugScreen.active
  DebugKeyHandler.enabled = DebugScreen.active
...
mod.debug_draw_slots = function(target_units, unit_extension_data, nav_world, t)
